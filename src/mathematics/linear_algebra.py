...
# Image processing functions have been moved to src/mathematics/image_processing.py
# Import them from there if needed:
# from src.mathematics.image_processing import (
#     visualize_image_as_matrix,
#     visualize_image_transformations,
#     visualize_image_filtering,
#     visualize_image_compression_svd,
...
if __name__ == "__main__":
    ...
    print("\nNote: Image processing functions are in src/mathematics/image_processing.py")
